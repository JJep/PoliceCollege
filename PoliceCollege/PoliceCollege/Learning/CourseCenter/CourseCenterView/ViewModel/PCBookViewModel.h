...
//获取推荐图书
-(void)getRecommendBookListAction:(NSInteger)num success:(PCSuccessHandler)success fail:(PCFailedHandler)fail ;
...
- (void)getBookChapterContenAction:(NSNumber *)sectionID success:(PCSuccessHandler)success fail:(PCFailedHandler)fail ;
 ...
 */
- (void)getBookListAction:(NSNumber *)sortType serchText:(NSString *)searchText typeID:(NSNumber *)typeID currentPage:(NSNumber *)currentPage ;
@end
